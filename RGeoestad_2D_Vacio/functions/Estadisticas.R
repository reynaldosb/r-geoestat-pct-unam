...
# var(as.data.frame(cbind(rnorm(100,1,0.7),rnorm(100,1,4),rnorm(100,5,2))))
    ...
    if(!is.null(Coordinates)) {
        ...
        Estadigrafos<-c("n","Distancia Máxima","Distancia Mínima", "Mí­nimo", "1er. Cuartil","Mediana", "Media","3er. Cuartil", "Máximo", "Rango","Rango intercuartil", "Varianza", "Desviación estándar", "Coeficiente de variación" ,"Coeficiente de asimetría", "Curtosis")
    } else {
        ...
        Estadigrafos<-c("n",                                       "Mínimo", "1er. Cuartil","Mediana", "Media","3er. Cuartil", "Máximo", "Rango","Rango intercuartil", "Varianza", "Desviación estándar", "Coeficiente de variación" ,"Coeficiente de asimetría", "Curtosis")
    }
    ...
    colnames(Estad)<-c("Estadígrafos","Valores")
